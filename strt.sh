...
#google-chrome-stable --ssl-version-min=tls1 --incognito  http://www.codeproject.com/  https://blog.codepath.com/2013/01/06/asynchronous-processing-in-web-applications-part-2-developers-need-to-understand-message-queues http://arne-mertz.de/2015/10/new-c-features-lambdas http://perfectionkills.com/javascript-quiz-es6/   http://cpphints.com http://macchina.io http://www.chess.com/article/view/the-enormous-importance-of-chess-psychology http://www.chess.com/blog/CoachJKane/zwischenzugs---keep-your-eyes-open http://www.wikihow.com/Understand-Camera-Exposure https://en.wikipedia.org/wiki/Exposure_(photography)  &> /dev/null &
#meetingcpp.com
